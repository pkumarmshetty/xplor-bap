  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        course.descriptor.name.titleBold(size: 16.sp, color: AppColors.textColor),
        if (course.descriptor.shortDesc.isNotEmpty) AppDimensions.extraSmall.vSpace(),
        if (course.descriptor.shortDesc.isNotEmpty)
          course.descriptor.shortDesc.titleRegular(size: 16.sp, color: AppColors.textColor),
            ...
            children: [
              RatingBar(
                ...
                ratingWidget: RatingWidget(
                  ...
                  empty: SvgPicture.asset(Assets.images.ratingHollow),
                ),
        ...
        if (course.tagData != null)
          Row(
            children: [
              ...
              AppDimensions.small.hSpace(),
              course.tagData!.level.value.titleBold(size: AppDimensions.smallXL.sp),
              AppDimensions.small.hSpace(),
              Container(
              ...
              AppDimensions.small.hSpace(),
              course.tagData!.duration.value.titleBold(size: AppDimensions.smallXL.sp),
            ],
          ),
