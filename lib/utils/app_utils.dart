  ...
  static void showAlertDialog(BuildContext context) {
    showCupertinoModalPopup<void>(
      ...
      builder: (BuildContext context) => CupertinoAlertDialog(
        ...
        content: 'Are you sure want to exit from application?'.titleSemiBold(size: 14.sp),
        actions: <CupertinoDialogAction>[
          CupertinoDialogAction(
            ...
            child: 'No'.titleSemiBold(size: 14.sp, color: AppColors.primaryColor),
          ),
          CupertinoDialogAction(
            ...
            child: 'Yes'.titleSemiBold(size: 14.sp, color: AppColors.primaryColor),
          ),
        ],
      ),
    );
