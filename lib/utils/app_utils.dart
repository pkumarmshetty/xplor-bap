...
class AppUtils {
  ...
  static void showAlertDialog(BuildContext context) {
    showDialog(context: context, builder: (BuildContext context){
      return AlertDialog(insetPadding: const EdgeInsets.symmetric(horizontal: 20),
        ...
        actions: <Widget>[
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: ButtonWidget(buttonBackgroundColor: AppColors.cancelButtonBgColor,
                ...
                Expanded(
                  child: ButtonWidget(fontSize: 12,
